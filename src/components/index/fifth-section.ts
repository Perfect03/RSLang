export const createFifthSection = () => {
    ...
    developer_img_box_one.src = 'main-assets/gleb.jpg'
    ...
    developer_img_box_two.src = 'main-assets/nikita.jpg'
    ...
    developer_img_box_three.src = 'main-assets/alisaa.jpg'
    ...
    main_section_five_card_one_about.textContent = 'Front-end developer, participated in the development of the registration form, the Sprint game and the group selector component'
    ...
    main_section_five_card_two_about.textContent = 'Front-end developer, participated in the development of the registration form, the Sprint game and the group selector component'
    ...
    main_section_five_card_three_about.textContent = 'Front-end developer, participated in the development of the registration form, the Sprint game and the group selector component'
