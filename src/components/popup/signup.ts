...
function signFunction() {
    let sign_name = (document.querySelector('.sign_name') as HTMLInputElement).value;
    let sign_email = (document.querySelector('.sign_email') as HTMLInputElement).value;
    let sign_pass = (document.querySelector('.sign_pass') as HTMLInputElement).value;
