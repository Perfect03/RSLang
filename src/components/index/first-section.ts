export const createFirstSection= () => {
    ...
    main_section_one_content_p.textContent = 'Memorizing English words can be fun and challenging. Play games, listen to pronunciation, improve your knowledge. With our app, learning is a joy.'
    ...
    main_section_one_img.src = 'main-assets/girl.jpg'
}